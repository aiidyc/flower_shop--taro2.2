...
var List = (_temp2 = _class = function (_Taro$Component) {
  ...
  function List() {
    ...
    }, _this.$usedState = ["anonymousState__temp", "$compid__82", "$compid__83", "$compid__84", "$compid__85", "$compid__86", "$compid__87", "$compid__88", "$compid__89", "$compid__90", "$compid__91", "$compid__92", "$compid__93", "$compid__94", "$compid__95", "$compid__96", "$compid__97", "$compid__98"], _this.customComponents = ["AtTabs", "AtTabsPane", "GoodsOne"], _temp), _possibleConstructorReturn(_this, _ret);
  }
  ...
  _createClass(List, [{
    ...
    value: function _createData() {
      ...
      var _genCompid15 = (0, _taroWeapp.genCompid)(__prefix + "$compid__89"),
          _genCompid16 = _slicedToArray(_genCompid15, 2),
          $prevCompid__89 = _genCompid16[0],
          $compid__89 = _genCompid16[1];

      var _genCompid17 = (0, _taroWeapp.genCompid)(__prefix + "$compid__90"),
          _genCompid18 = _slicedToArray(_genCompid17, 2),
          $prevCompid__90 = _genCompid18[0],
          $compid__90 = _genCompid18[1];

      var _genCompid19 = (0, _taroWeapp.genCompid)(__prefix + "$compid__91"),
          _genCompid20 = _slicedToArray(_genCompid19, 2),
          $prevCompid__91 = _genCompid20[0],
          $compid__91 = _genCompid20[1];

      var _genCompid21 = (0, _taroWeapp.genCompid)(__prefix + "$compid__92"),
          _genCompid22 = _slicedToArray(_genCompid21, 2),
          $prevCompid__92 = _genCompid22[0],
          $compid__92 = _genCompid22[1];

      var _genCompid23 = (0, _taroWeapp.genCompid)(__prefix + "$compid__93"),
          _genCompid24 = _slicedToArray(_genCompid23, 2),
          $prevCompid__93 = _genCompid24[0],
          $compid__93 = _genCompid24[1];

      var _genCompid25 = (0, _taroWeapp.genCompid)(__prefix + "$compid__94"),
          _genCompid26 = _slicedToArray(_genCompid25, 2),
          $prevCompid__94 = _genCompid26[0],
          $compid__94 = _genCompid26[1];

      var _genCompid27 = (0, _taroWeapp.genCompid)(__prefix + "$compid__95"),
          _genCompid28 = _slicedToArray(_genCompid27, 2),
          $prevCompid__95 = _genCompid28[0],
          $compid__95 = _genCompid28[1];

      var _genCompid29 = (0, _taroWeapp.genCompid)(__prefix + "$compid__96"),
          _genCompid30 = _slicedToArray(_genCompid29, 2),
          $prevCompid__96 = _genCompid30[0],
          $compid__96 = _genCompid30[1];

      var _genCompid31 = (0, _taroWeapp.genCompid)(__prefix + "$compid__97"),
          _genCompid32 = _slicedToArray(_genCompid31, 2),
          $prevCompid__97 = _genCompid32[0],
          $compid__97 = _genCompid32[1];

      var _genCompid33 = (0, _taroWeapp.genCompid)(__prefix + "$compid__98"),
          _genCompid34 = _slicedToArray(_genCompid33, 2),
          $prevCompid__98 = _genCompid34[0],
          $compid__98 = _genCompid34[1];
