...
var OrderTabs = (_temp2 = _class = function (_Taro$Component) {
  ...
  function OrderTabs() {
    ...
    }, _this.$usedState = ["$compid__103", "$compid__104", "$compid__105", "$compid__106", "$compid__107", "$compid__108", "$compid__109", "$compid__110", "$compid__111", "$compid__112", "$compid__113", "$compid__114", "$compid__115", "$compid__116", "$compid__117", "$compid__118", "$compid__119", "$compid__120"], _this.customComponents = ["AtTabs", "AtTabsPane", "OrderItem"], _temp), _possibleConstructorReturn(_this, _ret);
  }
  ...
  _createClass(OrderTabs, [{
    ...
    value: function _createData() {
      ...
      var _genCompid5 = (0, _taroWeapp.genCompid)(__prefix + "$compid__105"),
          _genCompid6 = _slicedToArray(_genCompid5, 2),
          $prevCompid__105 = _genCompid6[0],
          $compid__105 = _genCompid6[1];

      var _genCompid7 = (0, _taroWeapp.genCompid)(__prefix + "$compid__106"),
          _genCompid8 = _slicedToArray(_genCompid7, 2),
          $prevCompid__106 = _genCompid8[0],
          $compid__106 = _genCompid8[1];

      var _genCompid9 = (0, _taroWeapp.genCompid)(__prefix + "$compid__107"),
          _genCompid10 = _slicedToArray(_genCompid9, 2),
          $prevCompid__107 = _genCompid10[0],
          $compid__107 = _genCompid10[1];

      var _genCompid11 = (0, _taroWeapp.genCompid)(__prefix + "$compid__108"),
          _genCompid12 = _slicedToArray(_genCompid11, 2),
          $prevCompid__108 = _genCompid12[0],
          $compid__108 = _genCompid12[1];

      var _genCompid13 = (0, _taroWeapp.genCompid)(__prefix + "$compid__109"),
          _genCompid14 = _slicedToArray(_genCompid13, 2),
          $prevCompid__109 = _genCompid14[0],
          $compid__109 = _genCompid14[1];

      var _genCompid15 = (0, _taroWeapp.genCompid)(__prefix + "$compid__110"),
          _genCompid16 = _slicedToArray(_genCompid15, 2),
          $prevCompid__110 = _genCompid16[0],
          $compid__110 = _genCompid16[1];

      var _genCompid17 = (0, _taroWeapp.genCompid)(__prefix + "$compid__111"),
          _genCompid18 = _slicedToArray(_genCompid17, 2),
          $prevCompid__111 = _genCompid18[0],
          $compid__111 = _genCompid18[1];

      var _genCompid19 = (0, _taroWeapp.genCompid)(__prefix + "$compid__112"),
          _genCompid20 = _slicedToArray(_genCompid19, 2),
          $prevCompid__112 = _genCompid20[0],
          $compid__112 = _genCompid20[1];

      var _genCompid21 = (0, _taroWeapp.genCompid)(__prefix + "$compid__113"),
          _genCompid22 = _slicedToArray(_genCompid21, 2),
          $prevCompid__113 = _genCompid22[0],
          $compid__113 = _genCompid22[1];

      var _genCompid23 = (0, _taroWeapp.genCompid)(__prefix + "$compid__114"),
          _genCompid24 = _slicedToArray(_genCompid23, 2),
          $prevCompid__114 = _genCompid24[0],
          $compid__114 = _genCompid24[1];

      var _genCompid25 = (0, _taroWeapp.genCompid)(__prefix + "$compid__115"),
          _genCompid26 = _slicedToArray(_genCompid25, 2),
          $prevCompid__115 = _genCompid26[0],
          $compid__115 = _genCompid26[1];

      var _genCompid27 = (0, _taroWeapp.genCompid)(__prefix + "$compid__116"),
          _genCompid28 = _slicedToArray(_genCompid27, 2),
          $prevCompid__116 = _genCompid28[0],
          $compid__116 = _genCompid28[1];

      var _genCompid29 = (0, _taroWeapp.genCompid)(__prefix + "$compid__117"),
          _genCompid30 = _slicedToArray(_genCompid29, 2),
          $prevCompid__117 = _genCompid30[0],
          $compid__117 = _genCompid30[1];

      var _genCompid31 = (0, _taroWeapp.genCompid)(__prefix + "$compid__118"),
          _genCompid32 = _slicedToArray(_genCompid31, 2),
          $prevCompid__118 = _genCompid32[0],
          $compid__118 = _genCompid32[1];

      var _genCompid33 = (0, _taroWeapp.genCompid)(__prefix + "$compid__119"),
          _genCompid34 = _slicedToArray(_genCompid33, 2),
          $prevCompid__119 = _genCompid34[0],
          $compid__119 = _genCompid34[1];

      var _genCompid35 = (0, _taroWeapp.genCompid)(__prefix + "$compid__120"),
          _genCompid36 = _slicedToArray(_genCompid35, 2),
          $prevCompid__120 = _genCompid36[0],
          $compid__120 = _genCompid36[1];
