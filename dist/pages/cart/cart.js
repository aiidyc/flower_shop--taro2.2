...
var Cart = (_temp2 = _class = function (_Taro$Component) {
  ...
  function Cart() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Cart.__proto__ || Object.getPrototypeOf(Cart)).call.apply(_ref, [this].concat(args))), _this), _this.$usedState = ["props"], _this.customComponents = [], _temp), _possibleConstructorReturn(_this, _ret);
  }
...
var Cart__Connected = (0, _redux.connect)(stateP, null)(Cart);
...
},[["./src/pages/cart/cart.jsx","runtime","taro","vendors"]]]);