...
var Index = (_temp2 = _class = function (_Taro$Component) {
  ...
  function Index() {
    ...
    }, _this.$usedState = ["loopArray4", "$compid__33", "imgs"], _this.anonymousFunc0Map = {}, _this.customComponents = ["NewSwiper", "ShopList"], _temp), _possibleConstructorReturn(_this, _ret);
  }
