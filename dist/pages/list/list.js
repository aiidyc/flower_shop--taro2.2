...
var List = (_temp2 = _class = function (_Taro$Component) {
  ...
  function List() {
    ...
    }, _this.$usedState = ["anonymousState__temp", "$compid__73", "$compid__74", "$compid__75", "$compid__76", "$compid__77", "$compid__78", "$compid__79", "$compid__80", "$compid__81", "$compid__82", "$compid__83", "$compid__84", "$compid__85", "$compid__86", "$compid__87", "$compid__88", "$compid__89"], _this.customComponents = ["AtTabs", "AtTabsPane", "GoodsOne"], _temp), _possibleConstructorReturn(_this, _ret);
  }
  ...
  _createClass(List, [{
    ...
    value: function _createData() {
      ...
      var _genCompid17 = (0, _taroWeapp.genCompid)(__prefix + "$compid__81"),
          _genCompid18 = _slicedToArray(_genCompid17, 2),
          $prevCompid__81 = _genCompid18[0],
          $compid__81 = _genCompid18[1];

      var _genCompid19 = (0, _taroWeapp.genCompid)(__prefix + "$compid__82"),
          _genCompid20 = _slicedToArray(_genCompid19, 2),
          $prevCompid__82 = _genCompid20[0],
          $compid__82 = _genCompid20[1];

      var _genCompid21 = (0, _taroWeapp.genCompid)(__prefix + "$compid__83"),
          _genCompid22 = _slicedToArray(_genCompid21, 2),
          $prevCompid__83 = _genCompid22[0],
          $compid__83 = _genCompid22[1];

      var _genCompid23 = (0, _taroWeapp.genCompid)(__prefix + "$compid__84"),
          _genCompid24 = _slicedToArray(_genCompid23, 2),
          $prevCompid__84 = _genCompid24[0],
          $compid__84 = _genCompid24[1];

      var _genCompid25 = (0, _taroWeapp.genCompid)(__prefix + "$compid__85"),
          _genCompid26 = _slicedToArray(_genCompid25, 2),
          $prevCompid__85 = _genCompid26[0],
          $compid__85 = _genCompid26[1];

      var _genCompid27 = (0, _taroWeapp.genCompid)(__prefix + "$compid__86"),
          _genCompid28 = _slicedToArray(_genCompid27, 2),
          $prevCompid__86 = _genCompid28[0],
          $compid__86 = _genCompid28[1];

      var _genCompid29 = (0, _taroWeapp.genCompid)(__prefix + "$compid__87"),
          _genCompid30 = _slicedToArray(_genCompid29, 2),
          $prevCompid__87 = _genCompid30[0],
          $compid__87 = _genCompid30[1];

      var _genCompid31 = (0, _taroWeapp.genCompid)(__prefix + "$compid__88"),
          _genCompid32 = _slicedToArray(_genCompid31, 2),
          $prevCompid__88 = _genCompid32[0],
          $compid__88 = _genCompid32[1];

      var _genCompid33 = (0, _taroWeapp.genCompid)(__prefix + "$compid__89"),
          _genCompid34 = _slicedToArray(_genCompid33, 2),
          $prevCompid__89 = _genCompid34[0],
          $compid__89 = _genCompid34[1];
