...
__webpack_require__(/*! ./custom-variables.scss */ "./src/custom-variables.scss");
...
var _App = function (_BaseComponent) {
  ...
  function _App() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = _App.__proto__ || Object.getPrototypeOf(_App)).call.apply(_ref, [this].concat(args))), _this), _this.config = {
      pages: ['pages/index/index', 'pages/list/list', 'pages/cart/cart', 'pages/mine/mine', 'pages/mine/myAddress/index', 'pages/mine/myAddress/checkAddress', 'pages/order/orderTabs/orderTabs', 'pages/order/orderConfirm/orderConfirm', 'pages/order/productDetails/productDetails'],
      window: {
...
function counter() {
  ...
  switch (action.type) {
    case _reducersType.CART.ADD:
      return _extends({}, state, {
        shopNum: state.shopNum + 1
      });
    case _reducersType.CART.MINUS:
      return _extends({}, state, {
        shopNum: state.shopNum - 1
      });
