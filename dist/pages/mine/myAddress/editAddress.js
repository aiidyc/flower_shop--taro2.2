(wx["webpackJsonp"] = wx["webpackJsonp"] || []).push([["pages/mine/myAddress/editAddress"],{

/***/ "./node_modules/@tarojs/mini-runner/dist/loaders/wxTransformerLoader.js?!./src/pages/mine/myAddress/editAddress.jsx?taro&type=script&parse=PAGE&":
/*!****************************************************************************************************************************************************************!*\
  !*** ./node_modules/@tarojs/mini-runner/dist/loaders/wxTransformerLoader.js??ref--6-0!./src/pages/mine/myAddress/editAddress.jsx?taro&type=script&parse=PAGE& ***!
  \****************************************************************************************************************************************************************/
...
__webpack_require__(/*! ./editAddress.scss */ "./src/pages/mine/myAddress/editAddress.scss");
...
var MyAddress = (_temp2 = _class = function (_Taro$Component) {
  ...
  function MyAddress() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = MyAddress.__proto__ || Object.getPrototypeOf(MyAddress)).call.apply(_ref, [this].concat(args))), _this), _this.config = {
      ...
      // 获取全局状态变量和方法 放入props
    }, _this.$usedState = ["loopArray7", "allAddress"], _this.anonymousFunc0Map = {}, _this.customComponents = ["AddressItem"], _temp), _possibleConstructorReturn(_this, _ret);
  }
  ...
  _createClass(MyAddress, [{
    ...
    value: function _createData() {
      ...
      var getAddress = function getAddress(item, index) {
      ...
      var loopArray7 = allAddress.map(function (item, index) {
        ...
        _this2.anonymousFunc0Map[_$indexKey] = getAddress(item.$original, index);
  ...
  return MyAddress;
}(_taroWeapp2.default.Component), _class.$$events = ["anonymousFunc0"], _class.$$componentPath = "pages/mine/myAddress/editAddress", _temp2);
...
/***/ "./node_modules/file-loader/dist/cjs.js?name=[path][name].wxml&context=/Users/yuancong/Desktop/我的文件/yuancong1/线上文件/2020慧为Git/慧为小程序/鲜花/flower_shop/src!./node_modules/@tarojs/mini-runner/dist/loaders/miniTemplateLoader.js!./node_modules/@tarojs/mini-runner/dist/loaders/wxTransformerLoader.js?!./src/pages/mine/myAddress/editAddress.jsx?taro&type=template&parse=PAGE&":
/*!*********************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/file-loader/dist/cjs.js?name=[path][name].wxml&context=/Users/yuancong/Desktop/我的文件/yuancong1/线上文件/2020慧为Git/慧为小程序/鲜花/flower_shop/src!./node_modules/@tarojs/mini-runner/dist/loaders/miniTemplateLoader.js!./node_modules/@tarojs/mini-runner/dist/loaders/wxTransformerLoader.js??ref--6-0!./src/pages/mine/myAddress/editAddress.jsx?taro&type=template&parse=PAGE& ***!
  \*********************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__.p + "pages/mine/myAddress/editAddress.wxml";

/***/ }),

/***/ "./src/pages/mine/myAddress/editAddress.jsx":
/*!**************************************************!*\
  !*** ./src/pages/mine/myAddress/editAddress.jsx ***!
  \**************************************************/
/*! no static exports found */
...
/* harmony import */ var _editAddress_jsx_taro_type_template_parse_PAGE___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./editAddress.jsx?taro&type=template&parse=PAGE& */ "./src/pages/mine/myAddress/editAddress.jsx?taro&type=template&parse=PAGE&");
/* harmony import */ var _editAddress_jsx_taro_type_script_parse_PAGE___WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./editAddress.jsx?taro&type=script&parse=PAGE& */ "./src/pages/mine/myAddress/editAddress.jsx?taro&type=script&parse=PAGE&");
...
/***/ "./src/pages/mine/myAddress/editAddress.jsx?taro&type=script&parse=PAGE&":
/*!*******************************************************************************!*\
  !*** ./src/pages/mine/myAddress/editAddress.jsx?taro&type=script&parse=PAGE& ***!
  \*******************************************************************************/
/*! no static exports found */
...
/***/ "./src/pages/mine/myAddress/editAddress.jsx?taro&type=template&parse=PAGE&":
/*!*********************************************************************************!*\
  !*** ./src/pages/mine/myAddress/editAddress.jsx?taro&type=template&parse=PAGE& ***!
  \*********************************************************************************/
/*! no static exports found */
...
/***/ "./src/pages/mine/myAddress/editAddress.scss":
/*!***************************************************!*\
  !*** ./src/pages/mine/myAddress/editAddress.scss ***!
  \***************************************************/
/*! no static exports found */
...
},[["./src/pages/mine/myAddress/editAddress.jsx","runtime","taro","vendors","common"]]]);